...
if ( $GLOBALS['CC_POST_DATA']['logged_in'] ) {
	$GLOBALS['CC_POST_DATA']['sale'] = new WC_Product( ws_fst( get_field( CC_Controller::$field_keys['sale_product'], $id ))->ID );
	$GLOBALS['CC_POST_DATA']['share'] = new WC_Product( ws_fst( get_field( CC_Controller::$field_keys['share_product'], $id ))->ID );
	$GLOBALS['CC_POST_DATA']['rental'] = new WC_Product_Booking( ws_fst( get_field( CC_Controller::$field_keys['rental_product'], $id))->ID );
