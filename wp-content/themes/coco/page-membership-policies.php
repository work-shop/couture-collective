...
<div id="terms-and-conditions" class="template template-page">	
	...
	<section id="terms-membership" class="block m3">	
		<div class="container">
	...
	<section id="terms-share" class="block m3">	
		<div class="container">
			
			<div class="row">
			
				<div class="col-sm-12">
					<h4 class=" bordered serif centered m25">Share Purchase</h4>
				</div>
	...
	<section id="terms-fees" class="block m3">	
		<div class="container">
			
			<div class="row">
			
				<div class="col-sm-12">
					<h4 class=" bordered serif centered m25">Late Fees</h4>
				</div>
	...
	<section id="terms-delivery" class="block m3">	
		<div class="container">
			
			<div class="row">
			
				<div class="col-sm-12">
					<h4 class=" bordered serif centered m25">Delivery and Cleaning</h4>
				</div>
...
Members should not undertake to clean any garment themselves. All members agree to pay any additional cleaning costs associated with their wearing. While a standard cleaning cost will be displayed along with each item, any additional care deemed necessary such as spot cleaning or minor garment repair is at the discretion of Hallak Couture Cleaners, where the items will be inspected and stored. Local Delivery and Pickup are free as indicated in each item’s “more information” section. Fed-ex two-day shipping charges are charged to the member and will arrive with return packaging and instructions.
	...
	<section id="terms-loss" class="block m3">	
		<div class="container">
			
			<div class="row">
			
				<div class="col-sm-12">
					<h4 class=" bordered serif centered m25">Loss or Irreparable Damage to Property</h4>
				</div>
...
At the time of your purchase of a share in an Item, a member authorizes Co.Co. to charge her payment card for an amount equal to 110% of the original retail value of the Item (when new) plus applicable sales taxes, in case of irreparable damage or loss. Co.Co. must be notified immediately in the case of major damage or loss to avoid Late Fees which are not refundable.						</p>
	...
	<section id="terms-care" class="block m3">	
		<div class="container">
			
			<div class="row">
			
				<div class="col-sm-12">
					<h4 class=" bordered serif centered m25">Care and Courtesy</h4>
				</div>
				
				<div class="col-sm-10 col-sm-offset-1">
					<p class="h3 centered m25">
						Please refrain from spot cleaning your garment. Please do not apply an iron directly to the garment. Please apply perfume before putting on your garment. Please use paper shields when sliding your garment over make-up. Please refrain from sitting directly on bamboo or concrete seats as they can snag delicate fabrics (requesting an extra napkin usually does the trick).
						Please hang up your garment after wearing. 
					</p>
				</div>				
