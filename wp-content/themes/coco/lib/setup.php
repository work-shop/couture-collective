...
function theme_styles() { 
  ...
  wp_register_style( 'animation-css', get_template_directory_uri() . '/_/css/animations.css');         
  ...
  if ( file_exists( dirname( __FILE__ ) . '/env_prod' ) ) wp_enqueue_style( 'animation-css' );   
